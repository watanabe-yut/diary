...
- Interopの案内証を印刷(6/13)
- 手のひら静脈の登録
- アイテムボックスに入れてっていうissueを立てる
- interopのissue立てる
- pj会の前のディスカッションのための資料を用意する
  - 入出力もマルチモーダルなクレーム抽出に着目して調査＆論文調査する
  - 宮前さんに連絡
- 育成計画書
  - TIの途中でも留学にぜひ行きたい
  - 9月末までにMCEに関する何かしらの提案ができるように
  - そのためにTM(テクニカルメモランダム)をまとめる
    - 具体的な数値評価まではできなくてもいいから、先行研究の列挙とその課題、提案手法（つまりアイデア）ぐらいまではかけるとよい
    - 簡易検証できるとよいかも
    - 数式ベースの予測を立てる、でもよい
    - 簡易実験と仮説をアジャイルでやってくのが理想。だけど現実はなかなか忙しい
    - ボトムアップ研究提案
      - 研究員の方から提案する研究テーマ
      - 毎年行われる
      - 採用されることもある
